...
MOSFET의 기본 동작, leakage current, short-channel effects와 architecture evolution을 다룬다. 기본 동작 문서의 공통 기호와 측정 규약을 바탕으로 각 현상의 물리적 기원, 실제 추출식, 분리 방법과 구조적 억제책을 설명한다.
