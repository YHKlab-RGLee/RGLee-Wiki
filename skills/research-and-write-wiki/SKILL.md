...
9. Draft explanatory prose in Korean using `refs/format.md`, with representative scientific terms and labels in conventional English. Attach a multi-source citation cluster to each nontrivial claim and preserve original bibliographic titles.
